...
CREATE INDEX gk_role_body_metrics_role_id ON sous_chef_ums.ums_role_log (
    role_id ASC
);
COMMENT ON INDEX sous_chef_ums.gk_role_body_metrics_role_id IS 'General index of role id;The general index of role_id FK to id in user_role table';