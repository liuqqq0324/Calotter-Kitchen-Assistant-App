...
public class AiRecipeService {
    ...
    private static final String SYSTEM_PROMPT = String.join("\n",
            ...
            "",
            "GLOBAL HARD RULES:",
            "- Always return EXACTLY 5 menus in the 'menus' array. Never return fewer menus.",
            "- Each menu's 'recipes' length must equal generation_settings.dish_count.",
            "- Even if inventory/cookers/seasonings are empty, still generate realistic, healthy, minimal-ingredient recipes (basic pantry items allowed). Do NOT return empty menus.",
            "",
            ...
            "",
            "DIFFICULTY RULE:",
            "- generation_settings.difficulty_target is a LIST; choose recipes whose difficulty matches ANY value in that list.",
            "",
