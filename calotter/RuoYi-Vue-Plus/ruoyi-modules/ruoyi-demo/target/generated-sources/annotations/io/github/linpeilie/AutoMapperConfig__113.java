...
@MapperConfig(
    ...
    uses = {ConverterMapperAdapter__113.class, TestDemoBoToTestDemoMapper.class, TestDemoToTestDemoVoMapper.class, TestTreeVoToTestTreeMapper.class, TestTreeBoToTestTreeMapper.class, TestTreeToTestTreeVoMapper.class, TestDemoVoToTestDemoMapper.class},
    unmappedTargetPolicy = ReportingPolicy.IGNORE,
    builder = @Builder(buildMethod = "build", disableBuilder = true)
)
public interface AutoMapperConfig__113 {
}
