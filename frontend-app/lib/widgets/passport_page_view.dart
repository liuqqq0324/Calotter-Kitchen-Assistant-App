...
class PassportPageView extends StatefulWidget {
  ...
  }) : assert(pages.length == pageLabels.length, 'Pages and labels must have the same length');
...
class _PageBorderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 绘制手绘风格的边框
    path.moveTo(_randomOffset(0, roughness, random), _randomOffset(0, roughness, random));
