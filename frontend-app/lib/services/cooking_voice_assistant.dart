...
import 'package:personal_sous_chef/utils/speech_manager.dart';
...
class CookingVoiceAssistant {
  ...
  Future<bool> initialize() async {
    debugPrint('[VoiceAssistant] Voice assistant stub - initialization skipped');
  ...
  Future<void> startListening({
    ...
    debugPrint('[VoiceAssistant] Voice assistant stub - listening not supported');
    _isListening = false;
  ...
  VoiceCommandType recognizeCommand(String text) {
    debugPrint('[VoiceAssistant] Voice assistant stub - command recognition not supported');
  ...
  Future<void> speakStep(RecipeStepModel step) async {
    debugPrint('[VoiceAssistant] Voice assistant stub - text-to-speech not supported');
  }
