...
class HomepageApiService {
    ...
    try {
      if (_useMockApi) {
        ...
        for (final e in _mockTodayManualFoods) {
          final eff = (e['effectiveNutrition'] as Map?)
              ?.cast<String, dynamic>();
        ...
        return {
          ...
          'data': {
            ...
            'remaining': {
              ...
              'protein': (weeklyProteinTarget - consumedProtein).clamp(
                0.0,
                1e18,
              ),
              'fat': (weeklyFatTarget - consumedFat).clamp(0.0, 1e18),
              'carbohydrates': (weeklyCarbsTarget - consumedCarbs).clamp(
                0.0,
                1e18,
              ),
            },
        ...
        return {
          ...
          'data': {
            ...
            'remaining': {
              ...
              'protein': (dailyProteinTarget - consumedProtein).clamp(
                0.0,
                1e18,
              ),
              'fat': (dailyFatTarget - consumedFat).clamp(0.0, 1e18),
              'carbohydrates': (dailyCarbsTarget - consumedCarbs).clamp(
                0.0,
                1e18,
              ),
            },
      ...
      if (_useMockApi) {
        if (source == 'manual') {
          return {
            'success': true,
            'data': {
              'items': List<Map<String, dynamic>>.from(_mockTodayManualFoods),
            },
            'code': 200,
          };
        }
        if (source == 'recipe') {
          return {
            'success': true,
            'data': {
              'items': List<Map<String, dynamic>>.from(_mockTodayDishIntakes),
            },
            'code': 200,
          };
        }
  ...
  static Future<Map<String, dynamic>> updateIntakePercentage({
    ...
    try {
      if (_useMockApi) {
        final idx = _mockTodayDishIntakes.indexWhere(
          (e) => (e['intakeId'] as int?) == intakeId,
        );
        if (idx >= 0) {
    ...
    try {
      if (_useMockApi) {
        ...
        return {
          'success': true,
          'data': {
            'todayManualFoods': List<Map<String, dynamic>>.from(
              _mockTodayManualFoods,
            ),
          },
          'code': 200,
        };
  ...
  static Future<Map<String, dynamic>> deleteIntake({
    ...
    try {
      if (_useMockApi) {
        _mockTodayDishIntakes.removeWhere(
          (e) => (e['intakeId'] as int?) == intakeId,
        );
        _mockTodayManualFoods.removeWhere(
          (e) => (e['intakeId'] as int?) == intakeId,
        );
        return {'success': true, 'data': const {}, 'code': 200};
      }
    ...
    try {
      if (_useMockApi) {
        return {
          'success': true,
          'data': {
            'options': List<Map<String, dynamic>>.from(_mockLeftoverOptions),
          },
          'code': 200,
        };
      }
      ...
      if (_useMockApi) {
        ...
        return {
          ...
          'data': {
            ...
            'todayDishIntakes': List<Map<String, dynamic>>.from(
              _mockTodayDishIntakes,
            ),
          },
          'code': 200,
        };
