...
class StandardLibraryService {
  ...
  static const String _ingredientsCacheTimeKey =
      'standard_ingredients_cache_time';
  ...
  static Future<Map<String, dynamic>?> _getCachedIngredients() async {
    try {
      ...
      if (cacheData != null && cacheTime != null) {
        return {'data': jsonDecode(cacheData), 'timestamp': cacheTime};
      }
    } catch (e) {
