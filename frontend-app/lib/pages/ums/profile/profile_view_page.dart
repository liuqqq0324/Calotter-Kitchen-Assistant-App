...
class _ProfileViewPageState extends State<ProfileViewPage> {
      ...
      setState(() {
        ...
        if (_healthInfo != null) {
          ...
          _healthInfo = {
            ...
            if (data['dailyEnergy'] == null && _healthInfo!['dailyEnergy'] != null)
              'dailyEnergy': _healthInfo!['dailyEnergy'],
            if (data['dailyProtein'] == null && _healthInfo!['dailyProtein'] != null)
              'dailyProtein': _healthInfo!['dailyProtein'],
            if (data['dailyFat'] == null && _healthInfo!['dailyFat'] != null)
              'dailyFat': _healthInfo!['dailyFat'],
            if (data['dailyCarbohydrates'] == null && _healthInfo!['dailyCarbohydrates'] != null)
              'dailyCarbohydrates': _healthInfo!['dailyCarbohydrates'],
            if (data['dailyFiber'] == null && _healthInfo!['dailyFiber'] != null)
  ...
  Future<void> _saveHealthGoal() async {
    ...
    if (result['success'] == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(result['error'] ?? 'Failed to save health goal')),
      );
    }
  ...
  Widget _buildNutritionTargets() {
    ...
    // 如果没有任何营养数据，不显示
    if (dailyEnergy == null && dailyProtein == null && 
        dailyFat == null && dailyCarbohydrates == null && dailyFiber == null) {
        ...
        children: [
          ...
          if (dailyCarbohydrates != null) ...[
            ...
            _buildNutritionItem(
              icon: Icons.eco,
              label: 'Carbohydrates',
              value: dailyCarbohydrates.toInt(),
              unit: 'g',
              color: Colors.green,
            ),
          ],
                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) {
                            ...
                            if (bmiValue == null && user.height.isNotEmpty && user.weight.isNotEmpty) {
                              try {
                                final height = double.tryParse(user.height.replaceAll(' cm', '').trim());
                                final weight = double.tryParse(user.weight.replaceAll(' kg', '').trim());
