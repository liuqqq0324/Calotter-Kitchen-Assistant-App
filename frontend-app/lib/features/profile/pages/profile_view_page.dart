          ...
          child: SizedBox(
            ...
            child: Stack(
              children: [
                ...
                // 内容层
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), // 与 BMI padding 一致
                  child: Row(
                        ...
                        child: Stack(
                          children: [
                            ...
                            Transform.translate(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.fromLTRB(18, 10, 18, 80), // 增加底部 padding 让背景更长
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.center, // 居中对齐
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                  ...
                                  Center(
                                    ...
                                    const SizedBox(height: 40), // 增加底部间距，拉长背景图
                                  ],
                                ),
                              ),
                            ),
        ...
        builder: (context, constraints) {
          return Stack(
            children: [
              ...
              ..._buildNutritionEdgeIcons(screenSize.width, constraints.maxHeight > 0 ? constraints.maxHeight : screenSize.height),
            ],
          );
        },
      ),
